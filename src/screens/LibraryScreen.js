                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyContainer}>
                            <Ionicons name={searchQuery ? "search-outline" : "library-outline"} size={64} color={theme.text + '80'} />
                            <Text style={[styles.emptyText, { color: theme.text }]}>
                                {searchQuery ? "Aucun résultat" : "Bibliothèque vide"}
                            </Text>
                            <Text style={[styles.emptySubtext, { color: theme.text }]}>
                                {searchQuery ? "Essayez avec d'autres mots-clés" : "Aucun livre n'a pu être chargé"}
                            </Text>
                        </View>
                    }
                />
