                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyContainer}>
                            <Ionicons name="search-outline" size={64} color={theme.text} style={{ opacity: 0.5 }} />
                            <Text style={[styles.emptyText, { color: theme.text }]}>Aucun résultat</Text>
                            <Text style={[styles.emptySubtext, { color: theme.text, opacity: 0.6 }]}>Modifiez votre recherche pour trouver plus de romans</Text>
                        </View>
                    }
                />
            )}
