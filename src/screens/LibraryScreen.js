...
const LibraryScreen = () => {
    ...
    // ⚡ Bolt: Wrapped in useCallback to prevent re-creating the render function on every scroll/render,
    // which prevents unnecessary re-renders of the FlatList items.
