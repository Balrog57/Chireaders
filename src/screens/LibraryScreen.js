                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyContainer}>
                            <Ionicons name="search-outline" size={64} color={theme.text} style={{ opacity: 0.3 }} />
                            <Text style={[styles.emptyText, { color: theme.text }]}>
                                {searchQuery?.length > 0 ? "Aucun résultat trouvé" : "Bibliothèque vide"}
                            </Text>
                            <Text style={[styles.emptySubtext, { color: theme.text }]}>
                                {searchQuery?.length > 0 ? "Essayez de modifier votre recherche" : "Aucun roman dans cette section"}
                            </Text>
                        </View>
                    }
                />
