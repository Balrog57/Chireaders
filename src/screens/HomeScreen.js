    ...
    const renderLatestItem = useCallback(({ item }) => (
        <View style={[styles.latestItem, { borderBottomColor: theme.border }]}>
            ...
            <TouchableOpacity
                ...
                accessibilityRole="button"
                accessibilityLabel={item.latestChapter.title}
                accessibilityHint="Ouvre le lecteur sur ce chapitre"
            >
                ...
                {!loading &&
                    ...
                    homeData.latest.length === 0 && (
                        <View style={styles.emptyContainer}>
                            ...
                            <TouchableOpacity style={[styles.retryButton, { backgroundColor: theme.tint }]} onPress={onRefresh} accessibilityRole="button" accessibilityLabel="Réessayer de charger les romans" accessibilityHint="Recharge la page pour tenter de récupérer les données">
