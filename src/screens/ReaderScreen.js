    ...
    return (
        <View style={[styles.container, { backgroundColor: currentTheme.background }]}>
            ...
            <GestureDetector gesture={tapGesture}>
                {/*
                    ⚡ Bolt Optimization: Use Animated.FlatList instead of Animated.ScrollView + map.
                    This virtualizes the chapter content rendering, significantly reducing memory usage
                    and improving initial load time for long chapters.
                */}
                <Animated.FlatList
                    ref={scrollViewRef}
