...
const HistoryScreen = ({ navigation }) => {
    ...
    const renderHistoryItem = ({ item }) => {
        const formattedDate = formatDate(item.dateRead);
        ...
        return (
            <TouchableOpacity
                ...
                accessibilityLabel={`${item.seriesTitle}. Chapitre: ${item.title}. Lu ${formattedDate}`}
                accessibilityHint="Double-tapez pour continuer à lire ce chapitre"
            >
