...
export const StorageProvider = ({ children }) => {
     ...
     */
    // ⚡ Bolt: Mémoriser le dataset calculé pour éviter les ralentissements lors des re-rendus des consommateurs
    ...
    // Garder la fonction pour la rétrocompatibilité (si d'autres composants l'appellent en fonction)
    const getAllHistory = useCallback(() => allHistory, [allHistory]);
