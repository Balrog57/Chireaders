...
TaskManager.defineTask(TASK_NAME, async () => {
    try {
        ...
        try {
            ...
            else throw new Error('Invalid favorites format');
        } catch (e) {
            console.error('Failed to parse favorites in background task', e);
        ...
        if (updates.size > 0) {
            ...
            if (freshFavsJson) {
                try {
                    ...
                    console.error('Failed to parse fresh favorites', e);
                }
            }
