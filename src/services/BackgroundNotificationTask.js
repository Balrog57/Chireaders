...
TaskManager.defineTask(TASK_NAME, async () => {
    try {
        ...
        try {
            ...
            else return BackgroundFetch.BackgroundFetchResult.Failed;
        } catch (e) {
            console.error('[Sentinel] Failed to parse favorites:', e);
        ...
        if (updates.size > 0) {
            ...
            try {
                ...
                console.error('[Sentinel] Failed to parse fresh favorites:', e);
            }
