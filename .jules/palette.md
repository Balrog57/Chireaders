...
## 2024-04-27 - Actions secondaires invisibles (onLongPress)
...
**Action:** Explicitly describe the secondary action in the element's `accessibilityHint` to ensure full discoverability and accessibility.
