...
## 2024-05-24 - Virtualization for Unbounded Lists
**Learning:** Unbounded user-generated lists in React Native (like Favorites and History) can cause memory overhead and initial render delays.
**Action:** Always include virtualization properties (initialNumToRender, maxToRenderPerBatch, windowSize, and removeClippedSubviews={true}) on FlatList components.
