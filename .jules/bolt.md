...
## 2026-05-09 - Massive List Rendering & Search Optimization
**Learning:** For massive in-memory scraped datasets in React Native, filtering the list synchronously on every keystroke blocks the JS thread, and rendering massive unvirtualized lists consumes excessive memory and CPU.
