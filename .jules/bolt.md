...
## 2026-03-09 - Debouncing Search and FlatList Virtualization
**Learning:** For massive in-memory scraped datasets in React Native (e.g., `LibraryScreen.js`), real-time search filtering blocks the JS thread, and large unoptimized lists consume excessive memory and layout computation time.
