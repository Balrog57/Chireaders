...
## 2026-05-13 - DOM XSS Prevention
**Vulnerability:** Use of `innerHTML` for static string assignment in injected JavaScript.
**Learning:** Using `innerHTML` creates dormant DOM-based XSS vulnerabilities if the string later becomes dynamic or user-controlled.
**Prevention:** Always use `textContent` over `innerHTML` for safe static assignments in WebView injected scripts.
